...
public class FavoriteMovieListAdapter extends RecyclerView.Adapter<FavoriteMovieListAdapter.FavoriteViewHolder>{
        ...
        if (mFavorites != null) {
            ...
            holder.itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    favorite.setTitle(mFavorites.get(position).getTitle());
                    favorite.setGenre(mFavorites.get(position).getGenre());
                    favorite.setReleaseDate(mFavorites.get(position).getDate());
                    ...
                    detailMovieIntent.putExtra(DetailMovieActivity.EXTRA_MOVIE, favorite);
